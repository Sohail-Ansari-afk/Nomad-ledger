  ...
  return (
    <div className="card">
      <div className="card-header pb-2">
        <h2 className="section-heading" style={{ margin: 0 }}>Sign in to your account</h2>
      </div>
      <div className="card-body">
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '24px 0' }}>
          ...
          <div style={{ padding: '0 12px', fontSize: 11, color: 'var(--ink-4)', textTransform: 'uppercase', letterSpacing: '.05em', fontWeight: 600 }}>Or continue with</div>
          <div style={{ flex: 1, height: 1, background: 'var(--border)' }}></div>
        </div>
      ...
      <div className="card-header" style={{ justifyContent: 'center', background: 'var(--surface-2)', borderBottom: 'none', borderTop: '1px solid var(--border)' }}>
        <p style={{ fontSize: 13, color: 'var(--ink-3)', margin: 0 }}>
          Don't have an account? <Link href="/signup" style={{ color: 'var(--teal)', fontWeight: 500, textDecoration: 'none' }}>Sign up</Link>
        </p>
      </div>
    </div>
  )
